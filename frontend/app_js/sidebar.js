...
Vue.component("sidebar", {
    ...
    <div class="border-right" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">
        ...
        <router-link v-if="activeUser && activeUser.role == 'admin' && activeUser.organization" :to="'/organization/' + activeUser.organization.name" class="list-group-item list-group-item-action" v-bind:class="{active:activeTab=='organizations'}">Organization</router-link>
        ...
        <router-link v-if="activeUser && activeUser.role == 'superAdmin'" to="/categories" class="list-group-item list-group-item-action" v-bind:class="{active:activeTab=='categories'}">VM Categories</router-link>
